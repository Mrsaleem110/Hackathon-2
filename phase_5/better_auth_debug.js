console.log('Loading better_auth_debug.js...');
...
try {
  ...
  // If the app crashes here, this might not even be sent.
  // We need to rely on Vercel logs.
}
...
module.exports = app;
console.log('better_auth_debug.js loaded successfully.');
